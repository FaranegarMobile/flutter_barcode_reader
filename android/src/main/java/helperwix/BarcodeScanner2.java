...
import camerakit.camera.barcode.RotateLuminanceSource;
...
public class BarcodeScanner2 {
    ...
    public BarcodeScanner2(@NonNull Camera.PreviewCallback previewCallback, @NonNull ResultHandler resultHandler) {
    ...
    private LuminanceSource getLuminanceSource(byte[] data, int width, int height) {
        Rect rect = CameraViewManager2.getFramingRectInPreview(width, height);
        try {
            //if this line has error set public in node modules
