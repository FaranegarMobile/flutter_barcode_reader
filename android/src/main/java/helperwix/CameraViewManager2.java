...
import camerakit.Utils;
import camerakit.camera.Orientation;

import static camerakit.camera.Orientation.getSupportedRotation;


//If this lis has error please set class public in node modules


@SuppressWarnings("MagicNumber deprecation")
// We're still using Camera API 1, everything is deprecated
public class CameraViewManager2 {

    private static Camera camera = null;
    private static int currentCamera = 0;
    private static String flashMode = Camera.Parameters.FLASH_MODE_AUTO;
    private static Stack<CameraView2> cameraViews = new Stack<>();
    ...
    private static BarcodeScanner2.ResultHandler resultHandler;

    private static BarcodeScanner2 scanner;
    ...
    static void setCameraView(CameraView2 cameraView) {
        ...
        CameraViewManager2.cameraViews.push(cameraView);
        connectHolder();
    ...
    private static void setCameraRotation(int rotation, boolean force) {
        ...
        try {
            ...
            camera.setDisplayOrientation(Orientation.getDeviceOrientation(reactContext));
            camera.setParameters(parameters);
        } catch (Exception e) {
            Toast.makeText(reactContext
                    , "There is an error to initial camera, please try again"
                    , Toast.LENGTH_LONG)
                    .show();
    ...
    private static void updateCameraSize() {
        try {
            Camera camera = CameraViewManager2.getCamera();
    ...
    public static void setBarcodeScanner() {
        scanner = new BarcodeScanner2(previewCallback, resultHandler);
...
//    public void setShouldScan(CameraView2 view, boolean scanBarcode) {
...
//    public void setFrame(CameraView2 view, boolean show) {
//        view.setShowFrame(show);
//    }
//
//    @ReactProp(name = "frameColor", defaultInt = Color.GREEN)
//    public void setFrameColor(CameraView2 view, @ColorInt int color) {
//        view.setFrameColor(color);
//    }
//
//    @ReactProp(name = "laserColor", defaultInt = Color.RED)
//    public void setLaserColor(CameraView2 view, @ColorInt int color) {
//        view.setLaserColor(color);
//    }
//
//    @ReactProp(name = "surfaceColor")
//    public void setSurfaceBackground(CameraView2 view, @ColorInt int color) {
